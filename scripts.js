...
function renderTrainingPlan() {
    const days = [
        { day: '周一', exercises: [
            { name: '杠铃卧推', video: 'https://www.youtube.com/embed/YQ4-2ZJ41P8' },
            { name: '杠铃肩推', video: 'https://www.youtube.com/embed/abc123' }, // 示例链接
            { name: '三头肌下压', video: 'https://www.youtube.com/embed/def456' },
            { name: '平板支撑' }
        ]},
        { day: '周二', exercises: [
            { name: '硬拉', video: 'https://www.youtube.com/embed/5u1Ck3ZAv3M' },
            { name: '引体向上', video: 'https://www.youtube.com/embed/ghi789' },
            { name: '哑铃弯举' },
            { name: '仰卧卷腹' }
        ]},
        { day: '周三', exercises: [
            { name: '深蹲', video: 'https://www.youtube.com/embed/AaU57t8nJHw' },
            { name: '腿部推蹬机', video: 'https://www.youtube.com/embed/jkl012' },
            { name: '小腿提踵' },
            { name: '仰卧抬腿' }
        ]},
        { day: '周四', exercises: [
                ...
                td.innerHTML += `
                    ...
                    <div id="${id}" class="details">
                        ...
                        <div id="video_${id}" class="video-container" style="display: none;">
                            ${exercise.video ? `<iframe width="560" height="315" src="${exercise.video}" frameborder="0" allowfullscreen allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" title="Video demonstration"></iframe>` : ''}
                        </div>
                    </div>
                `;
            });
    ...
    if (videoDiv) {
        ...
        if (currentDisplay === 'none') {
            ...
            if (iframe && !iframe.src.includes('?enablejsapi=1')) {
                iframe.src += '?enablejsapi=1'; // 确保支持 JavaScript API
            }
        }
    } else {
